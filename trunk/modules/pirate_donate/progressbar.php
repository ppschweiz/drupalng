 ...
 * @param optional int maxVal (Max value (y in x/y), default 100)
 * @param optional int width (Width of progressbar in pixels, default 500)
 * @param optional int height (Height of progressbar in pixels, default 20)
 * @param optional int absVal (0 or 1, display absolute values instead of percent values, default 0)
 * @param optional string suffix (String to append to the numbers if absVal=true, default none)
 */
class progressBar
{
	private $curVal;
...
$progressBar = new progressBar($_GET['curVal'], $_GET['maxVal'], $_GET['width'], $_GET['height'], $_GET['absVal'], $_GET['suffix']);
$progressBar->draw();
